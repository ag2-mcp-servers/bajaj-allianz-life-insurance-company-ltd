...
#   timestamp: 2025-06-28T14:53:06+00:00
...
class CertificateParameters(BaseModel):
    ...
    PolicyNumber: str = Field(
        ...
        examples=['10 Digit Policy Number eg 0355555111'],
    )
...
class LicerCertificatePostRequest(BaseModel):
...
class LicerCertificatePostResponse(BaseModel):
...
class LicerCertificatePostResponse1(BaseModel):
...
class LicerCertificatePostResponse2(BaseModel):
...
class LicerCertificatePostResponse3(BaseModel):
...
class LicerCertificatePostResponse4(BaseModel):
...
class LicerCertificatePostResponse5(BaseModel):
...
class LicerCertificatePostResponse6(BaseModel):
